...
References
-[kabisa](https://github.com/kabisa/terraform-datadog-kubernetes)
...
module "datadog_monitor" {
    ...
    source                 = "app.terraform.io/CompanyNameGroup/monitor/datadog//_common_OS_system_monitor"
    version                = "~>2.0.0"
    ...
    url_workspace = "https://github.com/CompanyNameGroup2/terraform-datadog-monitor/tree/v2/_common_OS_system_monitor"
}
```
