...
References
-[clarane](https://github.com/claranet/terraform-datadog-monitors/tree/master/cloud/aws/lambda)
...
module "datadog_monitor" {
    ...
    source                 = "app.terraform.io/CompanyNameGroup/monitor/datadog//_common_aws_amazon_lambda_monitor"
    version                = "~>2.0.0"
